        ...
        <section id="evaluaciones" class="two">
            <div class="container">
                ...
                <p>
                    <ul class="icons">
                        <li>
                            <a href="preguntas.php" target="_blank" class="icon fa-plus">              <span class="label">Agregar evaluación</span>
                                       </a>
                        </li>
                        <li id="syncEvas">
                            ...
                            <tbody>
                                <!--<tr>
								        	...
								        	<td class="actions">
								        		<ul class="icons">
													<li>
														<a href="#edit" class="icon fa-pencil"><span class="label">Editar usuario</span></a>
														<a href="#delete" class="icon fa-trash-o"><span class="label">Eliminar usuario</span></a>
													</li>
												</ul>
								        	</td>
								        </tr>-->

			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post" action="php/login.php">
					...
					<div class="login100-form-social flex-c-m">
						<a href="https://www.facebook.com/AmicusDeMexicoSaDeCv/" class="login100-form-social-item flex-c-m bg1 m-r-5">
							<i class="fa fa-facebook-f" aria-hidden="true"></i>
						</a>

						<a  href="https://twitter.com/Amicus_Mark" class="login100-form-social-item flex-c-m bg2 m-r-5">
